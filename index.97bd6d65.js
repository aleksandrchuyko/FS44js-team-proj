 ...
 * limitations under the License.
 */
function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Et(),t=bt(e,"auth");return t.isInitialized()?t.getImmediate():or(e,{popupRedirectResolver:La,persistence:[Ai,oi,ui]})}();r.currentUser||function(e,t,r){return Ji.apply(this,arguments)}(Fa,ja).then((function(e){return Hn.credentialFromResult(e).accessToken,e.user.email})).catch((function(e){return e.code,e.message})).then((function(e){r.currentUser=e,console.log(r.currentUser)})).catch((function(e){console.log(e)}));var Va=new p;function Wa(){return(Wa=e(o)(e(u).mark((function t(r){var n;return e(u).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r.preventDefault(),console.log(r),n=r.target.textContent,console.log(n),e.next=6,Va.changePage(n);case 6:case"end":return e.stop()}}),t)})))).apply(this,arguments)}d.paginationList.addEventListener("click",(function(e){return Wa.apply(this,arguments)}));var Ha={header:document.querySelector(".header"),inputForm:document.querySelector(".header__searchform"),navHome:document.querySelector(".home__btn"),navLibrary:document.querySelector(".library__btn"),libraryBtns:document.querySelector(".library__list"),watchedBtn:document.querySelector(".watched-btn"),queueBtn:document.querySelector(".queue-btn")};Ha.navLibrary.addEventListener("click",(function(){Ha.inputForm.classList.add("is-hidden"),Ha.libraryBtns.classList.remove("is-hidden"),Ha.navLibrary.classList.add("current"),Ha.navHome.classList.remove("current"),Ha.header.classList.add("header__my-library")})),Ha.watchedBtn.addEventListener("click",(function(){Ha.queueBtn.classList.remove("active"),Ha.watchedBtn.classList.add("active")})),Ha.queueBtn.addEventListener("click",(function(){Ha.queueBtn.classList.add("active"),Ha.watchedBtn.classList.remove("active")})),d.headerSearch.addEventListener("submit",(function(e){return qa.apply(this,arguments)}));var za=new p;function qa(){return(qa=e(o)(e(u).mark((function t(r){var n,i;return e(u).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r.preventDefault(),za.search(),d.galleryContainer.innerHTML="",e.next=5,za.fetchMovies();case 5:return n=e.sent,console.log(n),i=n.total_pages,e.next=10,m(n);case 10:return e.next=12,I(i);case 12:case"end":return e.stop()}}),t)})))).apply(this,arguments)}}();
//# sourceMappingURL=index.97bd6d65.js.map
