 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */St="",ct(new be("platform-logger",(function(e){return new $e(e)}),"PRIVATE")),ct(new be("heartbeat",(function(e){return new It(e)}),"PRIVATE")),mt(tt,rt,St),mt(tt,rt,"esm2017"),mt("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xr(){return xr=e(l)(e(h).mark((function t(r){var n,i,a,o,s,u,c=arguments;return e(h).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=c.length>1&&void 0!==c[1]&&c[1],i=ge(r),e.next=4,i.getIdToken(n);case 4:return a=e.sent,Jt((o=Ir(a))&&o.exp&&o.auth_time&&o.iat,i.auth,"internal-error"),s="object"==typeof o.firebase?o.firebase:void 0,u=null==s?void 0:s.sign_in_provider,e.abrupt("return",{claims:o,token:a,authTime:_r(Er(o.auth_time)),issuedAtTime:_r(Er(o.iat)),expirationTime:_r(Er(o.exp)),signInProvider:u||null,signInSecondFactor:(null==s?void 0:s.sign_in_second_factor)||null});case 10:case"end":return e.stop()}}),t)}))),xr.apply(this,arguments)}function Er(e){return 1e3*Number(e)}function Ir(t){var r=e(B)(t.split("."),3),n=r[0],i=r[1],a=r[2];if(void 0===n||void 0===i||void 0===a)return Ft("JWT malformed, contained fewer than 3 sections"),null;try{var o=ne(i);return o?JSON.parse(o):(Ft("Failed to decode base64 JWT payload"),null)}catch(e){return Ft("Caught error parsing JWT payload as JSON",e),null}}function Tr(e,t){return Or.apply(this,arguments)}function Or(){return Or=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Ei("rcb"),new rr(3e4,6e4);var Ii="recaptcha";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:vt(),t=lt(e,"auth");return t.isInitialized()?t.getImmediate():Qt(e,{popupRedirectResolver:Ea,persistence:[ki,Qn,Zn]})}();r.currentUser||function(e,t,r){return Ui.apply(this,arguments)}(Ca,Aa).then((function(e){return Ln.credentialFromResult(e).accessToken,e.user.email})).catch((function(e){return e.code,e.message})).then((function(e){r.currentUser=e,console.log(r.currentUser)})).catch((function(e){console.log(e)}))}();
//# sourceMappingURL=index.5885ffe7.js.map
